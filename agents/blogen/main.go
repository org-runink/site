...
func main() {
	...
	md := renderMarkdown(a, slug, author)
	...
	fmt.Fprintf(os.Stderr, "blogen: sovereign article generated (local GKE model, no external AI) — %d body chars\n", len(a.Body))
...
func renderMarkdown(a *article, slug, author string) string {
