...
{{< section-container class="bg-stone-900 pt-20 pb-32" >}}
    <div class="text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-6 text-white">Partner With Runink</h1>
        <p class="text-xl text-[#D9CDB8] mb-12">Let's navigate your cloud, data, and generative AI challenges together. Connect with our expert consultants today.</p>
        <div class="max-w-3xl mx-auto bg-stone-800 rounded-xl shadow-xl border border-stone-700 p-8">
            <h2 class="text-3xl font-bold mb-4 text-white">How Can We Help?</h2>
            ...
            <div class="mt-8">
                ...
                <a class="inline-block bg-gradient-to-r from-[#8B9A6E] to-[#D4A574] hover:from-[#A8B88B] hover:to-[#E0B889] text-white font-semibold py-3 px-6 rounded-lg shadow" href="#" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/runink'});return false;">
                    Schedule a meeting
                </a>
            </div>
        </div>
...
{{< section-container class="py-20 bg-stone-900" >}}
    <div class="max-w-4xl mx-auto">
        <h2 class="text-3xl font-bold text-center mb-12 text-white">Send us a Message</h2>
