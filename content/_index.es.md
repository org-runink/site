...
products_intro: "Tres productos y un documento conjunto. Cada uno es un texto largo que explica el mecanismo en lugar de un folleto: qué mira el software, qué produce, quién lo aprueba y dónde se ejecuta."
...
products:
  ...
  - paper: "runink-core"
    name: "Runink CORE"
    sub: "La capa de operaciones que hay debajo de ambos"
    line: "No se compra por separado. Es la respuesta a dónde se procesan sus datos y quién puede verlos, que es la pregunta a la que acaba llegando cualquier otra página de aquí."
  - paper: "runink-core-atlas"
    name: "Runink CORE y Atlas"
    sub: "Un documento de arquitectura conjunto con Logical Leap"
    line: "Supervisión continua con una segunda opinión sobre cada hallazgo. Escrito con la otra empresa y no sobre ella, así que los dos equipos de ingeniería describen la misma forma."
