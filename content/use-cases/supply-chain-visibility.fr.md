...
<p class="mb-12">
    ...
    <div class="text-center mb-16">
        <h1 class="text-5xl md:text-6xl font-black !text-white text-white drop-shadow-md italic tracking-tighter uppercase mb-6">Quatre Systèmes. Une Matinée Que Vous N'avez Pas.</h1>
