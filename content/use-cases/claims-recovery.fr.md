...
<li><strong class="text-stone-200">La lettre est rédigée, pas envoyée.</strong> Une personne nommée lit le dossier, le corrige ou le rejette, et son accord reste au dossier. Rien ne part chez le transporteur avant cela.</li>
    ...
    <div class="flex flex-col gap-12 mb-20">
        ...
        <div>
            ...
            <p class="text-lg text-stone-400 font-medium mb-6">
                Un même problème de collecte, qui arrive sur trois bureaux sous trois formes différentes.
            </p>
            <ul class="text-lg text-stone-400 font-medium space-y-4 list-disc pl-6">
                <li><strong class="text-stone-200">Opérations réclamations.</strong> Ce qui arrive aujourd'hui, c'est un relevé du transporteur, un délai de dépôt et une matinée à chercher le reste &mdash; raison pour laquelle seuls les plus gros événements donnent lieu à une lettre. Ce qui change, c'est le début de la journée. La file, ce sont les dossiers que vos propres enregistrements soutiennent, classés, chacun portant l'envoi, les pièces et l'écart de quantité, avec la lettre déjà rédigée pour qu'une personne la juge.</li>
                <li><strong class="text-stone-200">Conformité douanière.</strong> Ce qui arrive aujourd'hui, c'est un avis de blocage dans la pile de la nuit, et les frais journaliers courent depuis des jours quand quelqu'un rapproche enfin le blocage de la facture. Ce qui change, c'est le moment et la complétude. La déclaration, le motif invoqué par le terminal et les papiers qui manquent au dossier arrivent ensemble, le jour où le blocage est enregistré.</li>
                <li><strong class="text-stone-200">Directeur financier.</strong> Ce qui arrive aujourd'hui, c'est une ligne de surestaries dans les comptes fournisseurs que personne ne rattache à une décision. Ce qui change, c'est ce que le chiffre veut dire. Le frais qui était évitable est montré à part des droits dus de toute façon, et chaque réclamation qui part porte le nom de la personne qui l'a validée.</li>
            </ul>
        </div>
        <div>
        ...
        <div class="bg-sheet p-8 rounded-2xl border border-stone-800/80 shadow-2xl">
             ...
             <ul class="text-lg text-stone-400 font-medium space-y-4 list-disc pl-6">
                <li><strong class="text-stone-200">Combien de réclamations recevables vous déposez vraiment.</strong> Prenez un trimestre de relevés d'incidents du transporteur. Comptez les événements qui ouvraient droit à réclamation. Comptez ensuite ceux que vous avez déposés, et si chacun tenait encore dans le délai du transporteur.</li>
                <li><strong class="text-stone-200">Le nombre de jours entre l'événement et le dépôt.</strong> Les mêmes relevés, mesurés comme un écart et non comme un total.</li>
                <li><strong class="text-stone-200">Les jours de surestaries et de détention.</strong> Ce sont les frais journaliers pour garder un conteneur au-delà du temps libre accordé. Prenez les factures du terminal et du transporteur, sur un trimestre entier, port par port. Séparez les jours dus aux papiers des jours dus aux files d'attente au port.</li>
                <li><strong class="text-stone-200">Le nombre de jours entre l'événement et le moment où quelqu'un le voit.</strong> Prenez la date à laquelle chaque blocage a été noté. Comparez-la à la date où une personne a agi pour la première fois. Peu d'équipes ont déjà compté cet écart. Tout le reste en dépend.</li>
             </ul>
...
{{< faq >}}
{
  "title": "Les Questions Qu'une Équipe Réclamations Pose D'abord",
  "description": "Ce qu'il lit, qui signe, et ce que le dossier montre un an après.",
  "questions": [
    {
      "question": "De quoi a-t-il besoin dans nos dossiers pour faire cela ?",
      "answer": "Des enregistrements que vous détenez déjà, lus là où ils sont déjà. Pour une réclamation fret : le relevé du transporteur sur ce qui s'est mal passé, puis le bon de commande, la facture et le connaissement du même envoi. Pour des frais de port : la déclaration, l'avis de blocage et le motif invoqué par le terminal, les documents qui manquent au dossier, et les frais journaliers portés sur la déclaration elle-même.<br><br>Rien n'est ressaisi et rien n'a besoin d'être chargé dans un nouveau système. Le corollaire mérite d'être dit franchement, parce que la plupart des produits le cachent : ne branchez rien et la file du matin est vide, car elle est faite de ce que disent vos propres enregistrements et de rien d'autre."
    },
    {
      "question": "Qui valide une réclamation qu'il rédige ?",
      "answer": "Une personne nommée de votre équipe. Le dossier arrive monté &mdash; la déclaration, le blocage, les documents qui manquent, l'écart de quantité s'il y en a un &mdash; avec la lettre déjà écrite, puis il attend. Quelqu'un le lit, le modifie ou le rejette. C'est la validation qui l'envoie au transporteur.<br><br>Cette validation reste au dossier à côté de ce qui a été décidé, et un rejet est consigné avec le même soin qu'une approbation. Le nom porté par la réclamation est celui de la personne qui l'a lue."
    },
    {
      "question": "Que se passe-t-il quand il se trompe, ou quand il ne peut pas trancher ?",
      "answer": "Vous l'apprenez avant le transporteur, parce que ce qu'il produit arrive à votre relecteur et non à votre contrepartie. Chaque constat porte les enregistrements qui l'ont construit &mdash; quels deux documents divergent et de combien, le blocage et le motif déclaré par le terminal &mdash; si bien que le relecteur juge le dossier sur les pièces plutôt que d'accepter une conclusion sur parole. Rejeter un dossier est une issue ordinaire, avec une trace ordinaire.<br><br>Là où il ne peut pas trancher, il le dit au lieu de combler le vide. Un chiffre qu'il ne peut pas tirer de vos propres enregistrements n'est pas imprimé comme une estimation, et lorsqu'une étape derrière une validation n'a pas été effectuée, la réponse nomme cette étape comme non exécutée au lieu de déclarer toute l'action faite. Personne n'apprend trois semaines plus tard que le dépôt n'est jamais parti."
    },
    {
      "question": "Comment l'exposition portuaire est-elle calculée ?",
      "answer": "Les jours d'immobilisation, multipliés par les frais journaliers portés sur la déclaration, et rien d'autre. Les droits de douane en sont volontairement exclus : ils sont dus que le conteneur bouge aujourd'hui ou la semaine prochaine, et les ajouter gonflerait l'exposition du montant d'une facture que personne n'a évitée.<br><br>Ce qu'on vous montre, c'est le frais qui était évitable. C'est un nombre plus petit que celui qu'impriment la plupart des outils, et c'est celui qui vaut la peine d'être porté devant un transporteur."
    },
    {
      "question": "Que voit un auditeur ensuite ?",
      "answer": "La déclaration et le blocage avec le motif invoqué par le terminal, les documents qui manquaient au dossier, l'écart entre la commande, la facture et le connaissement, la lettre telle qu'elle a été rédigée, et la personne qui l'a validée ou rejetée, avec la date.<br><br>La question posée un an plus tard &mdash; pourquoi cette réclamation a-t-elle été déposée, et sur quelle lecture &mdash; se lit donc au dossier, et non dans le souvenir d'une mauvaise semaine."
    },
    {
