---
title: "Volver a Calcular la Ruta Cuando el Día Ya Ha Cambiado"
description: "El plan que era óptimo a las seis de la mañana ya no lo es a las diez. Nadie lo vuelve a correr, porque volver a correrlo significa replanificar un día a mano. De esto se trata: de que la segunda pasada no cueste nada."
layout: "use_case"
product: "Runink FACE"
badge: "Gemelo de la Ruta"
    ...
    <div class="flex flex-col gap-12 mb-20">
        ...
        <div class="bg-sheet p-8 rounded-2xl border border-stone-800/80 shadow-2xl">
             ...
             <ul class="text-lg text-stone-400 font-medium space-y-4 list-disc pl-6">
                ...
                <li><strong class="text-stone-200">Planificado contra real, tramo por tramo.</strong> De su sistema de transporte: la distancia y el tiempo que el plan dio por supuestos, frente a la distancia y el tiempo que registró el vehículo. Llévelo por tramo, no por día &mdash; un día que cuadra está escondiendo dos tramos que no.</li>
                <li><strong class="text-stone-200">Ventanas perdidas, y cuáles de ellas eran evitables.</strong> De sus registros de entrega. Sepárelas en las que se perdieron antes de que el camión saliera y las que se perdieron durante el día. El segundo grupo es el que esto toca.</li>
                <li><strong class="text-stone-200">Horas extra de conductor y segundos viajes, por base.</strong> De nómina y de su registro de despacho. Son los dos sitios por donde la deriva sale del edificio, y normalmente se archivan donde nadie los conecta con la planificación de rutas.</li>
             </ul>
