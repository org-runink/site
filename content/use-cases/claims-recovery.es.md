    ...
    <div class="flex flex-col gap-12 mb-20">
        <div>
            ...
            <p class="text-lg text-stone-400 font-medium">
                Todas las pruebas ya existen en sus sistemas. Están en cuatro de ellos, en cuatro formatos, y unirlas es la parte para la que nadie tiene tiempo.
            </p>
        </div>
        <div>
        ...
        <div class="bg-sheet p-8 rounded-2xl border border-stone-800/80 shadow-2xl">
             ...
             <ul class="text-lg text-stone-400 font-medium space-y-4 list-disc pl-6">
                <li><strong class="text-stone-200">Cuántas reclamaciones que podía presentar presenta de verdad.</strong> Tome un trimestre de los registros del transportista sobre lo que salió mal. Cuente los casos por los que podría haber reclamado. Luego cuente cuántos presentó, y si cada uno seguía dentro del plazo del transportista.</li>
                <li><strong class="text-stone-200">Días entre el hecho y la presentación.</strong> Los mismos registros, medidos como una distancia y no como un total.</li>
                <li><strong class="text-stone-200">Días de demora y de detención.</strong> Son los cargos diarios por quedarse con un contenedor más tiempo del que sale gratis. Tome las facturas de la terminal y del transportista, un trimestre entero, puerto por puerto. Separe los días que causa un papel de los días que causa la cola del puerto.</li>
                <li><strong class="text-stone-200">Días entre el hecho y el momento en que alguien lo ve.</strong> Cuándo se anotó cada retención, frente a cuándo actuó una persona por primera vez. Pocos equipos han medido nunca esa distancia. Las demás cifras dependen de ella.</li>
             </ul>
