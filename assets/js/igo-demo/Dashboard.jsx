...
const SpendRecoveryModule = () => (
  <div style={{ padding: '20px', background: '#f8fdf8', border: '1px solid #10b981', borderRadius: '8px' }}>
    ...
    <ul>
      <li>LSS Tripartite BOL Reconciliation</li>
      <li>SLA Dispute Verification Matrix</li>
...
const PredictiveMaintenanceModule = () => (
  <div style={{ padding: '20px', background: '#fef8f8', border: '1px solid #ef4444', borderRadius: '8px' }}>
    <h2 style={{ color: '#b91c1c', marginTop: 0 }}>⚙️ Logistics & Quality Control Dashboard</h2>
    <p>Asset health or supply chain bottlenecks detected. Autonomous LSS engine scheduling is required.</p>
    <ul>
      <li>FMEA Carrier Risk Scoring</li>
      <li>Kanban Pull-System Signals</li>
      <li>Cpk Process Capability Monitoring</li>
    </ul>
...
const ComplianceModule = () => (
  <div style={{ padding: '20px', background: '#f8fafc', border: '1px solid #64748b', borderRadius: '8px' }}>
    ...
    <p>Ensure seamless global operations by staying ahead of regional requirements with continuous LSS compliance tracking.</p>
    <ul>
      <li>Jidoka (Stop-the-Line) Auto-Halts</li>
      <li>Y=f(X) Root-Cause Claim Modeling</li>
